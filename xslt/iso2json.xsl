...
<xsl:stylesheet 
  ...
  <xsl:template match="/">
    ...
    <xsl:text>{</xsl:text>
      ...
      <xsl:text>"dc_identifier_s": "</xsl:text><xsl:value-of select="/gmd:MD_Metadata/gmd:fileIdentifier/gco:CharacterString"/><xsl:text>",</xsl:text>
      ...
      <xsl:text>"layer_geom_type_s": "Polygon",</xsl:text>
